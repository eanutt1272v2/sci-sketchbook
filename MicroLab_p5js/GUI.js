class GUI {
   ...
   void displayStats() {
      ...
      text("MicroLab v2.0.0 Processing (Legacy) | https://www.github.com/eanutt1272.v2/MicroLab", space - guiRadius, height - 30);
      textAlign(RIGHT);
      text("Blackwell Labs | Software by @eanutt1272.v2", width - (space - guiRadius), height - 30);
   }
