class GUI
{
   ...
   void show()
   {
      ...
      textSize(20);
      fill(255);
      text("Particles: " + currentParticles, space - GUIRadius, 100);
      text("Types: " + man.types.size(), space - GUIRadius, 130);
      text("Range: " + range, space - GUIRadius, 160);
      text("Source: " + useSource, space - GUIRadius, 190);
