...
| [Fluvia Lite](./sketchbook/Fluvia_Lite) | Lightweight, browser-friendly Fluvia variant. | p5.js |
| [GLSL Shader Exploration 01](./sketchbook/GLSL_Shader_Exploration_01) | Experimental procedural shader playground. | p5.js, GLSL |
...
| [Neural Network](./sketchbook/Neural_Network) | Visual feedforward neural network demonstration. | Processing (Java) |
