...
void draw() 
{
   ...
   fill(0);
   text(magnets.currMagnet + " magnets, (a)dd, (d)el, (c)olor, (r)eset, (v)ectors" 
   + ", left mb to add & rotate, right bm to remove a magnet.", width/2, height-10); 
}
//----------------------------------------------------------
void keyPressed()
{
   ...
   {        case 'r':  magnets.clearAll();
      ...
      break; case 's':  save ("magnetic.jpg");
   }
}
...
final int unitSize = 8;   // each vector on a field is a "unit"
