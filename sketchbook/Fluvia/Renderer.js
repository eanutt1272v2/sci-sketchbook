class Renderer {
  ...
  renderStats() {
    ...
    const lines = [
      ...
      `Elevation Standard Deviation=${fmt(statistics.elevationStdDev, 3)} [height]`,
      ...
      `Discharge Minimum (normalised)=${fmt(statistics.dischargeBounds.min, 3)} [normalised]`,
      `Discharge Maximum (normalised)=${fmt(statistics.dischargeBounds.max, 3)} [normalised]`,
