class TabMethods {
  ...
  createRenderTab(page) {
    ...
    polar.addBinding(params, "autoCentre", {
      label: this.withHint("Auto-Centre", "autoCentre", "'"),
    });
...
for (const name of Object.getOwnPropertyNames(TabMethods.prototype)) {
  if (name === "constructor") continue;
  GUI.prototype[name] = TabMethods.prototype[name];
}
